...
with DAG(
    ...
    #     # bash_command=f'echo {days_ago(366*4)}'
    #     # bash_command=f'echo {{ds}} {{days_ago(366*2)}}'
    # )
    ...
    bigquery_external_table_task = BigQueryCreateExternalTableOperator(
        ...
        table_resource={
            "tableReference": {
                ...
                "tableId": "external_table_{{ execution_date.strftime(\'%Y-%m\') }}" #+dataset_file.split(".")[0].split("_")[-1],
            },
